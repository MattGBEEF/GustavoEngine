...
class ChartingState extends MusicBeatState
{
	...
	[
		...
		['Camera Flash', "Value 1: How long you want it to fade out.\nValue 2: What color you want it to be. Leave blank for white.\nExample: 0xFF0000 (Red)"]
	];
	...
	**/
	...
	override function create()
	{
		...
		var eventIcon:FlxSprite = new FlxSprite(-GRID_SIZE - 5, -90).loadGraphic(Paths.image('menus/editors/charteditor/eventArrow'));
		...
		quant = new AttachedSprite('chart_quant','menus/editors/charteditor/chart_quant');
	...
	function addSectionUI():Void
	{
		...
		stepperBeats = new FlxUINumericStepper(10, 100, 1, 4, 1, 16, 2);
	...
	function setupNoteData(i:Array<Dynamic>, isNextSection:Bool):Note
	{
		...
		if(daSus != null) { //Common note
			...
			note.loadGraphic(Paths.image('menus/editors/charteditor/eventArrow'));
